...
<head>
    ...
    <!--<link rel="stylesheet" href="https://fontawesome.com/icons/message?f=classic&s=regular">-->
...
<body>
    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0" style = "background-color: beige;">
                <tr>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-feedbacks">
                    
                        <a href="feedbacks.php" class="non-style-link-menu"><div><p class="menu-text">Feedbacks</p></a></div>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:16px;font-weight:700;color:var(--primarycolor);">
                                ...
                                <td>
                                    <p style="text-align:right;padding:10px;padding-right:100px;padding-bottom:0;font-size:16px;font-weight:700;color:var(--primarycolor);">
                                        Upcoming Sessions  until Next <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <!-- <p style="padding-bottom:19px;text-align:right;padding-right:20px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Here's Quick access to Upcoming Sessions that Scheduled until 7 days. Add,Remove and Many features available in @Schedule section.
                                    </p> -->
                                </td>
                            </tr>
                            <tr>
